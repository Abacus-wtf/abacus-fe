...
var MainInput = styled__default["default"](shardsReact.FormInput).attrs(function (props) { return ({
    size: props.size || "sm",
    ...props,
    ...
    return (React__default["default"].createElement(Container, { type: type },
        React__default["default"].createElement(Label, { style: { marginBottom: type === "checkbox" ? 0 : 10 }, htmlFor: id },
            ...
            infoText && (React__default["default"].createElement(React__default["default"].Fragment, null,
                ...
                React__default["default"].createElement(shardsReact.Tooltip, { open: isToolTipOpen, target: "#" + id, toggle: function () { return setIsToolTipOpen(!isToolTipOpen); }, placement: "right", trigger: "hover" }, infoText)))),
