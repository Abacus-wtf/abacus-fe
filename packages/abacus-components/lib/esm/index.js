...
var InputWithTitle = function (_a) {
    ...
    return (React__default.createElement(Container, { type: type },
        React__default.createElement(Label, { style: { marginBottom: type === "checkbox" ? 0 : 10 } },
            title,
        ...
        React__default.createElement(MainInput, __assign({ id: id, size: "lg", inputtype: type }, props))));
};
