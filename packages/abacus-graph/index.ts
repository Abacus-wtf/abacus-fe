...
export type VaultFragment = { __typename?: 'Vault', id: string, owner: string, status: number, timestamp: string, emissionsSigned: boolean, size: string, totalParticipants: number, nfts: Array<{ __typename?: 'NFT', id: string, address: string, tokenId: string }>, tickets: Array<{ __typename?: 'Ticket', id: string, ticketNumber: string, vaultAddress: string, tokenPurchasesLength: number, tokenPurchases: Array<{ __typename?: 'TokenPurchase', amount: string, id: string, length: string, owner: string, soldAt?: string | null, timestamp: string }> }> };
...
export type GetPoolsQuery = { __typename?: 'Query', vaults: Array<{ __typename?: 'Vault', id: string, owner: string, status: number, timestamp: string, emissionsSigned: boolean, size: string, totalParticipants: number, nfts: Array<{ __typename?: 'NFT', id: string, address: string, tokenId: string }>, tickets: Array<{ __typename?: 'Ticket', id: string, ticketNumber: string, vaultAddress: string, tokenPurchasesLength: number, tokenPurchases: Array<{ __typename?: 'TokenPurchase', amount: string, id: string, length: string, owner: string, soldAt?: string | null, timestamp: string }> }> }> };
...
export type GetPoolQuery = { __typename?: 'Query', vault?: { __typename?: 'Vault', id: string, owner: string, status: number, timestamp: string, emissionsSigned: boolean, size: string, totalParticipants: number, nfts: Array<{ __typename?: 'NFT', id: string, address: string, tokenId: string }>, tickets: Array<{ __typename?: 'Ticket', id: string, ticketNumber: string, vaultAddress: string, tokenPurchasesLength: number, tokenPurchases: Array<{ __typename?: 'TokenPurchase', amount: string, id: string, length: string, owner: string, soldAt?: string | null, timestamp: string }> }> } | null };
