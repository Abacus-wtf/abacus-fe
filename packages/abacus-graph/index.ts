...
export type QuerySellablePositionArgs = {
  block?: InputMaybe<Block_Height>;
  id: Scalars['ID'];
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type QuerySellablePositionsArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']>;
...
export type SellablePosition_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  amount?: InputMaybe<Scalars['BigInt']>;
  amount_gt?: InputMaybe<Scalars['BigInt']>;
...
export type SubscriptionSellablePositionArgs = {
  block?: InputMaybe<Block_Height>;
  id: Scalars['ID'];
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type SubscriptionSellablePositionsArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']>;
  orderBy?: InputMaybe<SellablePosition_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
...
export type VaultSellablePositionsArgs = {
  first?: InputMaybe<Scalars['Int']>;
  orderBy?: InputMaybe<SellablePosition_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']>;
...
export type NftFragment = { __typename?: 'NFT', id: string, address: string, tokenId: string, vaults?: Array<{ __typename?: 'VaultNFT', vault: { __typename?: 'Vault', id: string, name: string, size: string } }> | null };
...
export type GetNftQuery = { __typename?: 'Query', nft?: { __typename?: 'NFT', id: string, address: string, tokenId: string, vaults?: Array<{ __typename?: 'VaultNFT', vault: { __typename?: 'Vault', id: string, name: string, size: string } }> | null } | null };
...
export type NfTsQuery = { __typename?: 'Query', nfts: Array<{ __typename?: 'NFT', id: string, address: string, tokenId: string, vaults?: Array<{ __typename?: 'VaultNFT', vault: { __typename?: 'Vault', id: string, name: string, size: string } }> | null }> };

export type VaultFragment = { __typename?: 'Vault', id: string, name: string, owner: string, status: number, timestamp: number, emissionsSigned: boolean, totalParticipants: number, nfts?: Array<{ __typename?: 'VaultNFT', nft: { __typename?: 'NFT', id: string, address: string, tokenId: string, vaults?: Array<{ __typename?: 'VaultNFT', vault: { __typename?: 'Vault', id: string, name: string, size: string } }> | null }, vault: { __typename?: 'Vault', id: string, size: string } }> | null, tickets: Array<{ __typename?: 'Ticket', id: string, ticketNumber: number, vaultAddress: string, tokenPurchasesLength: number, tokenPurchases: Array<{ __typename?: 'TokenPurchase', amount: string, id: string, startEpoch: number, finalEpoch: number, owner: string, timestamp: string }> }>, sellablePositions: Array<{ __typename?: 'SellablePosition', id: string, nonce: number, owner: string, timestamp: number, amount: string, vaultAddress: string, startEpoch: number, finalEpoch: number, soldAt?: string | null }> };
...
export type VaultNftFragment = { __typename?: 'VaultNFT', nft: { __typename?: 'NFT', id: string, address: string, tokenId: string, vaults?: Array<{ __typename?: 'VaultNFT', vault: { __typename?: 'Vault', id: string, name: string, size: string } }> | null }, vault: { __typename?: 'Vault', id: string, size: string } };
