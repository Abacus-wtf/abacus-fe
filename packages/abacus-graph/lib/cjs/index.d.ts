...
export declare const GetAggregatesDocument: DocumentNode<
  GetAggregatesQuery,
  Exact<{
    [key: string]: never;
  }>
>;
export declare const GetPoolsDocument: DocumentNode<
  GetPoolsQuery,
  Exact<{
    first: Scalars["Int"];
    skip: Scalars["Int"];
...
>;
export declare const GetTicketsDocument: DocumentNode<
  GetTicketsQuery,
  Exact<{
    first: Scalars["Int"];
    skip: Scalars["Int"];
