...
const Breakdown: FunctionComponent = () => (
  <Container>
    <Row>
      ...
      <RowData>
        90% of all ETH revenue generated by Abacus will be paid to veABC holders
        (in the form of ETH).
      </RowData>
    </Row>
    <Row>
      ...
      <RowData>
        The epoch distribution gauge controls the premium size that the protocol
        offers to different NFT collections.
      </RowData>
    </Row>
    <Row>
      <RowHead>
