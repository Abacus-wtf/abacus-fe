...
export const ABC_CONTROLLER = IS_PRODUCTION
  ? ""
  : "0xC021b6583145b29914A0c9Ecf0Ba9089C147a0fC"

export const ABC_TREASURY = IS_PRODUCTION
  ? ""
  : "0x144Edb633aBcee8a736DFA62ac1f778f648c4CB9"

export const ABC_FACTORY = IS_PRODUCTION
  ? ""
  : "0x64C25f061d88F05B345BFCe26B6Fe276B8525705"

export const ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0x66F37650BF2Bd45DAFaCdD37811F0258CE0a9e70"

export const VE_ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0x9c81e5c8b6DdbDeDcCF1F367E29e459e02C9E180"

export const ABC_EPOCH = IS_PRODUCTION
  ? ""
  : "0xaBf540505757aFcC17122f83F05001Ff3414Cb88"

export const ABC_BRIBE_FACTORY = IS_PRODUCTION
  ? ""
  : "0xdA37E28d8ACCa039f220b67407Dbb419Cc1F7F35"

export const DN_TOKEN = IS_PRODUCTION
  ? ""
  : "0xbC61148F4da4Ef1256840AE339B6569B2f800FA8"

export const ABC_CREDIT_BONDS = IS_PRODUCTION
  ? ""
  : "0xC6BC8D48C61ddFeEb3F8b8b06A4cbd926B4C9683"
