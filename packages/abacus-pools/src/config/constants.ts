...
export const ABC_CONTROLLER = IS_PRODUCTION
  ? ""
  : "0xeC88f2f4E8D7aF586e371993b41905EE20654509"

export const ABC_TREASURY = IS_PRODUCTION
  ? ""
  : "0xA900D172aa37aAD6d93319e0A34750CD6524d647"

export const ABC_FACTORY = IS_PRODUCTION
  ? ""
  : "0x9690009f71dc0aB9DD108b53e39e283aBeDDab86"

export const ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0x0Cd41bC29AFBFf32F3f1732D3cf725B2e5E54496"

export const VE_ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0x3187E5E275b898919F0C50ACB251e68Dd0116122"

export const ABC_EPOCH = IS_PRODUCTION
  ? ""
  : "0x5Ad243D226ab001F6EB7e7fd0C4D1C60aE300b97"

export const ABC_BRIBE_FACTORY = IS_PRODUCTION
  ? ""
  : "0xF4395c7072eE02Dd255F0eEeb3992aA36c6eEaBc"

export const DN_TOKEN = IS_PRODUCTION
  ? ""
  : "0x28cE87BD2A0e6FbB0c152De840DeE0568D6e0929"

export const ABC_CREDIT_BONDS = IS_PRODUCTION
  ? ""
  : "0xbFDF04454644B076EFD2E9F7790b70324c965DeD"
