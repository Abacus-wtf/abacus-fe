...
export const ABC_CONTROLLER = IS_PRODUCTION
  ? ""
  : "0x389e01A602471C0AC9B2Cb1aFE06c320aC773fa0"

export const ABC_TREASURY = IS_PRODUCTION
  ? ""
  : "0x512b9eC249D89919BB4845569a5C148447046Bb2"

export const ABC_FACTORY = IS_PRODUCTION
  ? ""
  : "0x4cA8e195fC177B15d737bA25aFd789DBB30eA15c"

export const ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0x1C72B37D0BA12e35D11C54722cE5B2E5F9b83F66"

// TODO: Rename this ABC_ALLOCATOR
export const VE_ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0x90D3968B3EbC245424213900989eD1F412fe3F93"

export const ABC_EPOCH = IS_PRODUCTION
  ? ""
  : "0x6d55f5Edcba286be9cf83d7e108EB46d1b83ba6D"
...
export const ABC_CREDIT_BONDS = IS_PRODUCTION
  ? ""
  : "0x7c7dAb7F5b3c0C126e5737F9Ce5C41ed66F7a999"

export const ABC_NFT_ETH = IS_PRODUCTION
  ? ""
  : "0x8968d9B14896d4B3f384dF5631Db20488512737D"

export const ABC_LEND = IS_PRODUCTION
  ? ""
  : "0xBcB0B39A121F852df3C4E438B8DD05742696D6ED"
