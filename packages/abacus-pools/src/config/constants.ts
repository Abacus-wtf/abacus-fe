...
export const ABC_CONTROLLER = IS_PRODUCTION
  ? ""
  : "0xE7A333d91d0dAa19170c71c6f8eCD4cFb11B3B42"

export const ABC_TREASURY = IS_PRODUCTION
  ? ""
  : "0x01049fEbdFcDe11623308f4E8BaeF138eAc91CC5"

export const ABC_FACTORY = IS_PRODUCTION
  ? ""
  : "0xfadeE12ac79EC964FEd95F406F6A68a559f30FAd"

export const ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0xDFbF0446d64D9b199f9075D2AA3E0BaeBB7583fA"

export const VE_ABC_TOKEN = IS_PRODUCTION
  ? ""
  : "0xcF023a90F9a820bB7e6edA63A61857F92951C107"

export const ABC_EPOCH = IS_PRODUCTION
  ? ""
  : "0x3f57C1a9AC16e22D337F11eD19319d85a601A1DD"

export const ABC_BRIBE_FACTORY = IS_PRODUCTION
  ? ""
  : "0x2B328904acc6eaEa30A446544de768d69338B648"
