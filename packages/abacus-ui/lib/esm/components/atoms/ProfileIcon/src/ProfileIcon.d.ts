declare const _default: import("styled-components").StyledComponent<"img", import("styled-components").DefaultTheme, {
    ...
    css?: import("styled-components").CSSProp<import("styled-components").DefaultTheme> | undefined;
    alt: string;
