...
var FontImport = function () { return css(templateObject_1$X || (templateObject_1$X = __makeTemplateObject(["\n  @import url(\"https://rsms.me/inter/inter.css\");\n"], ["\n  @import url(\"https://rsms.me/inter/inter.css\");\n"]))); };
...
var Media = breakpoints.reduce(function (accumulator, _a) {
    ...
    var nextMedia = function (first) {
        ...
        return css(templateObject_3$m || (templateObject_3$m = __makeTemplateObject(["\n      @media (min-width: ", ") {\n        ", ";\n      }\n    "], ["\n      @media (min-width: ", ") {\n        ", ";\n      }\n    "])), value, css.apply(void 0, __spreadArrays([first], interpolations)));
    };
...
var templateObject_1$X, templateObject_2$w, templateObject_3$m;

var Container$I = styled.div(templateObject_1$W || (templateObject_1$W = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("exa"));
var templateObject_1$W;

var Container$H = styled.div(templateObject_1$V || (templateObject_1$V = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("giga"));
var templateObject_1$V;

var Container$G = styled.h1(templateObject_1$U || (templateObject_1$U = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("exa"));
var templateObject_1$U;

var Container$F = styled.h2(templateObject_1$T || (templateObject_1$T = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("peta"));
var templateObject_1$T;

var Container$E = styled.h3(templateObject_1$S || (templateObject_1$S = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("tera"));
var templateObject_1$S;

var Container$D = styled.h4(templateObject_1$R || (templateObject_1$R = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("giga"));
var templateObject_1$R;

var Container$C = styled.h5(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("mega"));
var templateObject_1$Q;

var StyledH6 = styled.h6(templateObject_1$P || (templateObject_1$P = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font());
var templateObject_1$P;

var StyledDiv = styled.div(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font());
var templateObject_1$O;

var Container$B = styled.div(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  ", ";\n"], ["\n  ", ";\n"])), Font("mega"));
var templateObject_1$N;

var Container$A = styled.div(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("milli"));
var templateObject_1$M;

var StyledP = styled.p(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font());
var templateObject_1$L;

var Container$z = styled.div(templateObject_1$K || (templateObject_1$K = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("peta"));
var templateObject_1$K;

var Container$y = styled.small(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("milli"));
var templateObject_1$J;

var Container$x = styled.div(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("tera"));
var templateObject_1$I;

var Container$w = styled.div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("yotta"));
var templateObject_1$H;

var Container$v = styled.div(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), Font("zetta"));
var templateObject_1$G;

var Container$u = styled.div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
var InputContainer = styled.div(templateObject_3$l || (templateObject_3$l = __makeTemplateObject(["\n  background-color: white;\n  display: flex;\n  width: 100%;\n  flex-direction: row-reverse;\n  justify-content: space-between;\n  align-items: stretch;\n  box-shadow: 0px 2px 0px #f6f6f6;\n\n  ", "\n\n  &:focus-within {\n    box-shadow: 0px 2px 0px #6b6b6b;\n  }\n"], ["\n  background-color: white;\n  display: flex;\n  width: 100%;\n  flex-direction: row-reverse;\n  justify-content: space-between;\n  align-items: stretch;\n  box-shadow: 0px 2px 0px #f6f6f6;\n\n  ",
    "\n\n  &:focus-within {\n    box-shadow: 0px 2px 0px #6b6b6b;\n  }\n"])), function (_a) {
    var disabled = _a.disabled;
    return disabled
        ? css(templateObject_2$v || (templateObject_2$v = __makeTemplateObject(["\n          background-color: rgba(239, 239, 239, 0.3);\n          color: rgb(84, 84, 84);\n          cursor: not-allowed;\n        "], ["\n          background-color: rgba(239, 239, 239, 0.3);\n          color: rgb(84, 84, 84);\n          cursor: not-allowed;\n        "]))) : "";
});
var StyledLabel$1 = styled.label(templateObject_4$e || (templateObject_4$e = __makeTemplateObject(["\n  ", "\n  text-align: center;\n  background-color: ", ";\n  padding: 10px;\n  height: calc(100% - 17px);\n  margin: 8.5px 0;\n  border-radius: ", ";\n"], ["\n  ", "\n  text-align: center;\n  background-color: ", ";\n  padding: 10px;\n  height: calc(100% - 17px);\n  margin: 8.5px 0;\n  border-radius: ", ";\n"])), Font("milli"), function (_a) {
    var theme = _a.theme;
...
var StyledInput$1 = styled.input(templateObject_6$a || (templateObject_6$a = __makeTemplateObject(["\n  ", "\n  border: none;\n  outline: none;\n  padding: 0;\n  width: 100%;\n  padding-right: 6px;\n\n  ", "\n"], ["\n  ", "\n  border: none;\n  outline: none;\n  padding: 0;\n  width: 100%;\n  padding-right: 6px;\n\n  ",
    "\n"])), Font("mega"), function (_a) {
    var disabled = _a.disabled;
    return disabled
        ? css(templateObject_5$c || (templateObject_5$c = __makeTemplateObject(["\n          background: unset;\n          cursor: not-allowed;\n        "], ["\n          background: unset;\n          cursor: not-allowed;\n        "]))) : "";
});
var StyledKilo$4 = styled(StyledDiv)(templateObject_7$7 || (templateObject_7$7 = __makeTemplateObject(["\n  color: ", ";\n  margin-top: 10px;\n"], ["\n  color: ", ";\n  margin-top: 10px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core["900"];
});
var EthLogo$1 = styled(Container$A)(templateObject_8$5 || (templateObject_8$5 = __makeTemplateObject(["\n  background-color: ", ";\n  padding: 10px;\n  color: ", ";\n  border-radius: ", ";\n  font-weight: 600;\n  margin-bottom: 7px;\n"], ["\n  background-color: ", ";\n  padding: 10px;\n  color: ", ";\n  border-radius: ", ";\n  font-weight: 600;\n  margin-bottom: 7px;\n"])), function (_a) {
    var theme = _a.theme;
...
var Input = function (_a) {
    var value = _a.value, onChange = _a.onChange, type = _a.type, label = _a.label, name = _a.name, id = _a.id, placeholder = _a.placeholder, showEth = _a.showEth, className = _a.className, hint = _a.hint, disabled = _a.disabled;
    var ID = typeof id === "string" ? id : getUniqueId("input");
    return (React.createElement(Container$u, { className: className },
        React.createElement(InputContainer, { disabled: disabled },
            ...
            React.createElement(StyledInput$1, { id: ID, name: name, value: value, type: type, placeholder: placeholder, onChange: function (e) { return onChange(e.target.value); }, disabled: disabled, "aria-disabled": disabled })),
        hint && React.createElement(StyledKilo$4, null, hint)));
};
var templateObject_1$F, templateObject_2$v, templateObject_3$l, templateObject_4$e, templateObject_5$c, templateObject_6$a, templateObject_7$7, templateObject_8$5;

var Container$t = styled.section(templateObject_2$u || (templateObject_2$u = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  padding: 20px;\n  background: ", ";\n  box-shadow: ", ";\n  border-radius: ", ";\n\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  padding: 20px;\n  background: ", ";\n  box-shadow: ", ";\n  border-radius: ", ";\n\n  ",
    "\n"])), function (_a) {
    var theme = _a.theme;
...
}, Media.sm(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n    flex-direction: row;\n    align-items: center;\n    justify-content: flex-start;\n  "], ["\n    flex-direction: row;\n    align-items: center;\n    justify-content: flex-start;\n  "]))));
var Section = function (_a) {
    var children = _a.children;
    return (React.createElement(Container$t, null, children));
};
...
var Container$s = styled.div(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  grid-gap: 10px;\n"], ["\n  display: flex;\n  flex-direction: column;\n  grid-gap: 10px;\n"])));
var MiniContainer = styled.div(templateObject_2$s || (templateObject_2$s = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n"])));
var StyledKilo$3 = styled(StyledDiv)(templateObject_5$b || (templateObject_5$b = __makeTemplateObject(["\n  ", ";\n\n  color: ", ";\n"], ["\n  ",
    ";\n\n  color: ",
    ";\n"])), function (_a) {
    var isValue = _a.isValue;
    return isValue
        ? css(templateObject_3$k || (templateObject_3$k = __makeTemplateObject(["\n          word-break: break-word;\n        "], ["\n          word-break: break-word;\n        "]))) : css(templateObject_4$d || (templateObject_4$d = __makeTemplateObject(["\n          flex: 1 0 auto;\n          margin-right: 16px;\n        "], ["\n          flex: 1 0 auto;\n          margin-right: 16px;\n        "])));
}, function (_a) {
...
var Divider$4 = styled.div(templateObject_6$9 || (templateObject_6$9 = __makeTemplateObject(["\n  background: ", ";\n  opacity: 0.1;\n  height: 2px;\n  width: 100%;\n"], ["\n  background: ",
    ";\n  opacity: 0.1;\n  height: 2px;\n  width: 100%;\n"])), function (_a) {
    ...
    return (React.createElement(Container$s, { className: className }, Object.entries(info).map(function (_a, index) {
        ...
        return (React.createElement(React.Fragment, { key: key },
            React.createElement(MiniContainer, null,
                React.createElement(StyledKilo$3, { isValue: false, isDark: isDark || false },
                    React.createElement("b", null, key)),
                React.createElement(StyledKilo$3, { isValue: true, isDark: isDark || false }, value)),
            index !== Object.entries(info).length - 1 ? (React.createElement(Divider$4, { isDark: isDark || false })) : null));
    })));
};
var templateObject_1$C, templateObject_2$s, templateObject_3$k, templateObject_4$d, templateObject_5$b, templateObject_6$9;

var Container$r = styled.span(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  border: 0px;\n  clip: rect(0px, 0px, 0px, 0px);\n  height: 1px;\n  width: 1px;\n  margin: -1px;\n  padding: 0px;\n  overflow: hidden;\n  white-space: nowrap;\n  position: absolute;\n"], ["\n  border: 0px;\n  clip: rect(0px, 0px, 0px, 0px);\n  height: 1px;\n  width: 1px;\n  margin: -1px;\n  padding: 0px;\n  overflow: hidden;\n  white-space: nowrap;\n  position: absolute;\n"])));
...
var Shimmer = keyframes(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n    0% {\n        background-position: 100% 0;\n    }\n    100% {\n        background-position: -100% 0;\n    }\n"], ["\n    0% {\n        background-position: 100% 0;\n    }\n    100% {\n        background-position: -100% 0;\n    }\n"])));
...
var ImageContainer$2 = styled.div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  width: 100%;\n  height: 0;\n  padding-bottom: 100%;\n  background-color: ", ";\n  border-radius: ", ";\n  transition: transform ", ";\n\n  &:hover {\n    transform: ", ";\n  }\n"], ["\n  width: 100%;\n  height: 0;\n  padding-bottom: 100%;\n  background-color: ", ";\n  border-radius: ",
    ";\n  transition: transform ", ";\n\n  &:hover {\n    transform: ",
    ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var IndivContainer = styled.div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-right: 30px;\n\n  &:last-of-type {\n    margin-right: 0;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-right: 30px;\n\n  &:last-of-type {\n    margin-right: 0;\n  }\n"])));
var Text = styled(StyledDiv)(templateObject_3$j || (templateObject_3$j = __makeTemplateObject(["\n  ", "\n  margin-bottom: 6px;\n"], ["\n  ",
    "\n  margin-bottom: 6px;\n"])), Media.md(templateObject_2$q || (templateObject_2$q = __makeTemplateObject(["\n    font-size: 18px;\n  "], ["\n    font-size: 18px;\n  "]))));
var Subtext = styled(Container$A)(templateObject_5$a || (templateObject_5$a = __makeTemplateObject(["\n  ", "\n  color: ", ";\n\n  ", "\n"], ["\n  ", "\n  color: ", ";\n\n  ",
    "\n"])), Font("nano"), function (_a) {
    var theme = _a.theme;
    return theme.colors.core[900];
}, Media.md(templateObject_4$c || (templateObject_4$c = __makeTemplateObject(["\n  ", "\n  "], ["\n  ", "\n  "])), Font("milli")));
var templateObject_1$x, templateObject_2$q, templateObject_3$j, templateObject_4$c, templateObject_5$a;

var Fallback$3 = function () { return (React.createElement("div", { style: { display: "flex" } },
...
var Container$q = styled.div(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  grid-gap: ", ";\n  align-items: ", ";\n"], ["\n  display: flex;\n  flex-direction: column;\n  grid-gap: ", ";\n  align-items: ", ";\n"])), function (_a) {
...
var BoldenKilo = styled(StyledDiv)(templateObject_3$i || (templateObject_3$i = __makeTemplateObject(["\n  color: ", ";\n  font-weight: 600;\n  ", "\n\n  ", "\n"], ["\n  color: ",
    ";\n  font-weight: 600;\n  ", "\n\n  ",
    "\n"])), function (_a) {
...
var StyledGiga = styled(Container$H)(templateObject_5$9 || (templateObject_5$9 = __makeTemplateObject(["\n  color: ", ";\n  ", ";\n  width: 100%;\n  text-align: inherit;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n\n  ", "\n\n  ", "\n"], ["\n  color: ",
    ";\n  ", ";\n  width: 100%;\n  text-align: inherit;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n\n  ", "\n\n  ",
    "\n"])), function (_a) {
    var theme = _a.theme, isCardBar = _a.isCardBar;
    return isCardBar ? theme.colors.core[900] : "black";
...
var ColoredKilo = styled(StyledDiv)(templateObject_7$6 || (templateObject_7$6 = __makeTemplateObject(["\n  color: ", ";\n\n  ", "\n\n  ", "\n"], ["\n  color: ", ";\n\n  ", "\n\n  ",
    "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core[900];
...
var ExploreInfo = function (_a) {
    ...
    return (React.createElement(Container$q, { isCardBar: isCardBar || false, className: className },
...
var templateObject_1$w, templateObject_2$p, templateObject_3$i, templateObject_4$b, templateObject_5$9, templateObject_6$8, templateObject_7$6;
...
// You probably want to change this to something semantic or abandon it all together
var Container$p = styled.div(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  border-radius: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  width: auto;\n  height: 100%;\n  padding: 20px;\n  display: flex;\n  flex-direction: row;\n"], ["\n  border-radius: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  width: auto;\n  height: 100%;\n  padding: 20px;\n  display: flex;\n  flex-direction: row;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.section;
}, function (_a) {
    var theme = _a.theme;
...
var CardBackground = function (_a) {
    ...
    return (React.createElement(Container$p, { style: __assign({}, style), isHalfScreen: isHalfScreen || false }, children));
};
var templateObject_1$u;

// You probably want to change this to something semantic or abandon it all together
var Container$o = styled.div(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  margin: 0;\n  position: relative;\n  width: max-content;\n  margin-right: 6px;\n  margin-bottom: 12px;\n"], ["\n  margin: 0;\n  position: relative;\n  width: max-content;\n  margin-right: 6px;\n  margin-bottom: 12px;\n"])));
...
var StyledInput = styled.input(templateObject_3$h || (templateObject_3$h = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  opacity: 0;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: -1;\n\n  &:checked ~ ", " {\n    border: 2px solid ", ";\n  }\n\n  &:focus ~ ", " {\n    outline: 1px solid ", ";\n  }\n\n  &:checked&:focus ~ ", " {\n    border: 2px solid ", ";\n    outline: 1px solid ", ";\n    box-shadow: 0 0 0 2px ", ";\n  }\n"], ["\n  position: absolute;\n  top: 0;\n  opacity: 0;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: -1;\n\n  &:checked ~ ", " {\n    border: 2px solid ", ";\n  }\n\n  &:focus ~ ", " {\n    outline: 1px solid ", ";\n  }\n\n  &:checked&:focus ~ ", " {\n    border: 2px solid ", ";\n    outline: 1px solid ", ";\n    box-shadow: 0 0 0 2px ", ";\n  }\n"])), StyledLabel, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$t, templateObject_2$o, templateObject_3$h;
...
var MegaStyled$2 = styled(Container$B)(templateObject_2$n || (templateObject_2$n = __makeTemplateObject(["\n  color: ", ";\n  font-weight: 600;\n"], ["\n  color: ", ";\n  font-weight: 600;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.utility.blue;
});
var AbacusBalance = function (_a) {
    ...
    return (React.createElement(Container$n, null,
        React.createElement("img", { src: BlueEthLogo, alt: "Blue Eth Logo" }),
...
// You probably want to change this to something semantic or abandon it all together
var Container$m = styled.div(templateObject_3$g || (templateObject_3$g = __makeTemplateObject(["\n  position: fixed;\n  left: 0;\n  right: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 16px;\n  background-color: ", ";\n  color: ", ";\n  ", "\n  ", ";\n"], ["\n  position: fixed;\n  left: 0;\n  right: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 16px;\n  background-color: ",
    ";\n  color: ", ";\n  ",
    "\n  ",
    ";\n"])), function (_a) {
...
var PersistentBanner = function (_a) {
    ...
    return React.createElement(Container$m, __assign({}, rest), children);
};
var templateObject_1$r, templateObject_2$m, templateObject_3$g;
...
var PetaModified = styled.div(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  ", ";\n  margin-left: 8px;\n  color: ", ";\n"], ["\n  ", ";\n  margin-left: 8px;\n  color: ",
...
var Container$l = styled.div(templateObject_2$l || (templateObject_2$l = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  cursor: pointer;\n  transition: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"], ["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  cursor: pointer;\n  transition: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.transitionTime.main;
});
var Logo = function (_a) {
    var onClick = _a.onClick, _b = _a.isDark, isDark = _b === void 0 ? false : _b;
    return (React.createElement(Container$l, { onClick: onClick },
...
var StatText = styled.div(templateObject_2$k || (templateObject_2$k = __makeTemplateObject(["\n  ", ";\n  color: ", ";\n  text-align: center;\n  display: flex;\n  justify-content: center;\n"], ["\n  ", ";\n  color: ", ";\n  text-align: center;\n  display: flex;\n  justify-content: center;\n"])), Font("tena", "Bluu Next"), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.white;
});
var Title$3 = styled(Container$B)(templateObject_3$f || (templateObject_3$f = __makeTemplateObject(["\n  color: ", ";\n  text-align: center;\n"], ["\n  color: ", ";\n  text-align: center;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.lightWhite;
});
var StatInfo = function (_a) {
    ...
    return (React.createElement(Container$k, { className: className },
...
var templateObject_1$p, templateObject_2$k, templateObject_3$f;

var ImageContainer$1 = styled.div(templateObject_2$j || (templateObject_2$j = __makeTemplateObject(["\n  position: relative; /* If you want text inside of it */\n  max-width: 400px;\n  width: 70%;\n\n  ", "\n"], ["\n  position: relative; /* If you want text inside of it */\n  max-width: 400px;\n  width: 70%;\n\n  ",
    "\n"])), Media.lg(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n    height: 350px;\n  "], ["\n    height: 350px;\n  "]))));
var ImageStyled = styled.img(templateObject_3$e || (templateObject_3$e = __makeTemplateObject(["\n  transform: rotate(15deg);\n  width: 100%;\n"], ["\n  transform: rotate(15deg);\n  width: 100%;\n"])));
var Container$j = styled.div(templateObject_5$8 || (templateObject_5$8 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  grid-gap: 20px;\n  width: 100%;\n  justify-content: space-evenly;\n\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  grid-gap: 20px;\n  width: 100%;\n  justify-content: space-evenly;\n\n  ",
    "\n"])), Media.sm(templateObject_4$a || (templateObject_4$a = __makeTemplateObject(["\n    padding: 0 90px;\n    width: calc(100% - 180px);\n  "], ["\n    padding: 0 90px;\n    width: calc(100% - 180px);\n  "]))));
var ZettaStyled = styled(Container$v)(templateObject_6$7 || (templateObject_6$7 = __makeTemplateObject(["\n  font-family: \"Bluu Next\";\n  color: ", ";\n  text-align: center;\n"], ["\n  font-family: \"Bluu Next\";\n  color: ", ";\n  text-align: center;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.white;
});
var MegaStyled$1 = styled(Container$B)(templateObject_7$5 || (templateObject_7$5 = __makeTemplateObject(["\n  flex: 1 0 auto;\n  color: ", ";\n  text-align: center;\n"], ["\n  flex: 1 0 auto;\n  color: ", ";\n  text-align: center;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.lightWhite;
});
...
var templateObject_1$o, templateObject_2$j, templateObject_3$e, templateObject_4$a, templateObject_5$8, templateObject_6$7, templateObject_7$5;

var ImageSection = styled.img(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  width: 280px;\n  height: 280px;\n  border-top-left-radius: ", ";\n  border-top-right-radius: ", ";\n  object-fit: cover;\n"], ["\n  width: 280px;\n  height: 280px;\n  border-top-left-radius: ", ";\n  border-top-right-radius: ", ";\n  object-fit: cover;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.section;
}, function (_a) {
    var theme = _a.theme;
...
var MegaStyled = styled(Container$B)(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  color: ", ";\n  font-family: \"Bluu Next\";\n  padding-bottom: 24px;\n  text-decoration: none;\n\n  &::after {\n    content: \"\";\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n  }\n"], ["\n  color: ", ";\n  font-family: \"Bluu Next\";\n  padding-bottom: 24px;\n  text-decoration: none;\n\n  &::after {\n    content: \"\";\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.white;
});
var Container$i = styled.div(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n  position: relative;\n  border-radius: ", ";\n  background-color: rgba(255, 255, 255, 0.1);\n  transition: ", ";\n  padding: 0px;\n  width: 280px;\n  height: 480px;\n\n  &:hover {\n    opacity: 0.7;\n  }\n"], ["\n  position: relative;\n  border-radius: ", ";\n  background-color: rgba(255, 255, 255, 0.1);\n  transition: ", ";\n  padding: 0px;\n  width: 280px;\n  height: 480px;\n\n  &:hover {\n    opacity: 0.7;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.section;
}, function (_a) {
    var theme = _a.theme;
...
var BottomSection = styled.div(templateObject_4$9 || (templateObject_4$9 = __makeTemplateObject(["\n  padding: 24px;\n  padding-top: 18px;\n  display: flex;\n  flex-direction: column;\n"], ["\n  padding: 24px;\n  padding-top: 18px;\n  display: flex;\n  flex-direction: column;\n"])));
...
var templateObject_1$n, templateObject_2$i, templateObject_3$d, templateObject_4$9;
...
// You probably want to change this to something semantic or abandon it all together
var Container$h = styled.div(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n"], ["\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n"])));
var StyledLink = styled.a(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  display: flex;\n  margin: 0 12px;\n  cursor: pointer;\n\n  &:first-of-type {\n    margin-left: 0;\n  }\n\n  &:last-of-type {\n    margin-right: 0;\n  }\n\n  & path {\n    fill: ", ";\n  }\n\n  &:hover,\n  &:focus {\n    & path {\n      fill: ", ";\n    }\n  }\n"], ["\n  display: flex;\n  margin: 0 12px;\n  cursor: pointer;\n\n  &:first-of-type {\n    margin-left: 0;\n  }\n\n  &:last-of-type {\n    margin-right: 0;\n  }\n\n  & path {\n    fill: ", ";\n  }\n\n  &:hover,\n  &:focus {\n    & path {\n      fill: ", ";\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.utility.white;
}, function (_a) {
    var theme = _a.theme;
...
var SocialLinks = function (_a) {
    ...
    return (React.createElement(Container$h, { className: className },
...
var ButtonStyled$1 = styled(Button)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  grid-gap: 8px;\n  display: flex;\n  flex-direction: row;\n  color: black;\n  padding: 0px;\n"], ["\n  grid-gap: 8px;\n  display: flex;\n  flex-direction: row;\n  color: black;\n  padding: 0px;\n"])));
...
// You probably want to change this to something semantic or abandon it all together
var Container$g = styled.div(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  border-radius: 60px;\n  box-shadow: ", ";\n  padding: 20px;\n  background-color: ", ";\n  width: fit-content;\n  display: flex;\n  height: 16px;\n  align-items: center;\n"], ["\n  border-radius: 60px;\n  box-shadow: ", ";\n  padding: 20px;\n  background-color: ", ";\n  width: fit-content;\n  display: flex;\n  height: 16px;\n  align-items: center;\n"])), function (_a) {
    var theme = _a.theme;
...
var Bead = styled.button(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  background-color: ", ";\n  cursor: ", ";\n  border-radius: 20px;\n  height: 16px;\n  width: 12px;\n  border: 1px solid ", ";\n  position: absolute;\n  z-index: 1;\n  transform: translateX(\n    ", "px\n  );\n  ", "\n\n  transition: transform ", ";\n"], ["\n  background-color: ",
    ";\n  cursor: ",
    ";\n  border-radius: 20px;\n  height: 16px;\n  width: 12px;\n  border: 1px solid ", ";\n  position: absolute;\n  z-index: 1;\n  transform: translateX(\n    ",
    "px\n  );\n  ", "\n\n  transition: transform ", ";\n"])), function (_a) {
...
var GradientLine = styled.div(templateObject_3$c || (templateObject_3$c = __makeTemplateObject(["\n  height: 2px;\n  width: 250px;\n  z-index: 0;\n  background: linear-gradient(90deg, #3e74ff -14.08%, rgba(0, 0, 0, 0) 127.23%);\n"], ["\n  height: 2px;\n  width: 250px;\n  z-index: 0;\n  background: linear-gradient(90deg, #3e74ff -14.08%, rgba(0, 0, 0, 0) 127.23%);\n"])));
...
var templateObject_1$k, templateObject_2$g, templateObject_3$c;

var Container$f = styled.div(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  border-radius: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  display: flex;\n  flex-direction: column;\n  padding: 0px;\n  position: relative;\n"], ["\n  border-radius: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  display: flex;\n  flex-direction: column;\n  padding: 0px;\n  position: relative;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.section;
}, function (_a) {
    var theme = _a.theme;
...
var SecondHalf = styled.div(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 15px 20px;\n  box-sizing: border-box;\n"], ["\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 15px 20px;\n  box-sizing: border-box;\n"])));
var Title$2 = styled.h3(templateObject_4$8 || (templateObject_4$8 = __makeTemplateObject(["\n  text-align: center;\n  margin-bottom: 18px;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  max-width: 100%;\n  ", "\n\n  ", "\n"], ["\n  text-align: center;\n  margin-bottom: 18px;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  max-width: 100%;\n  ", "\n\n  ",
    "\n"])), Font("peta", "Bluu Next"), Media.md(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n    ", "\n  "], ["\n    ", "\n  "])), Font("zetta", "Bluu Next")));
var Divider$3 = styled.hr(templateObject_5$7 || (templateObject_5$7 = __makeTemplateObject(["\n  margin: 18px 0px;\n  width: 100%;\n  border-color: ", ";\n"], ["\n  margin: 18px 0px;\n  width: 100%;\n  border-color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.border;
});
var ExploreInfoContainer = styled.div(templateObject_7$4 || (templateObject_7$4 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  width: 100%;\n  justify-content: center;\n  margin-bottom: 18px;\n  text-align: center;\n\n  ", "\n"], ["\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  width: 100%;\n  justify-content: center;\n  margin-bottom: 18px;\n  text-align: center;\n\n  ",
    "\n"])), Media.sm(templateObject_6$6 || (templateObject_6$6 = __makeTemplateObject(["\n    grid-column-gap: 50px;\n    width: max-content;\n  "], ["\n    grid-column-gap: 50px;\n    width: max-content;\n  "]))));
var ButtonStyled = styled(Button)(templateObject_8$4 || (templateObject_8$4 = __makeTemplateObject(["\n  display: flex;\n  text-align: center;\n  justify-content: center;\n  width: 100%;\n"], ["\n  display: flex;\n  text-align: center;\n  justify-content: center;\n  width: 100%;\n"])));
var ProfileGroupContainer = styled.div(templateObject_10$2 || (templateObject_10$2 = __makeTemplateObject(["\n  display: none;\n  margin-top: 18px;\n\n  ", "\n"], ["\n  display: none;\n  margin-top: 18px;\n\n  ",
    "\n"])), Media.md(templateObject_9$4 || (templateObject_9$4 = __makeTemplateObject(["\n    display: block;\n  "], ["\n    display: block;\n  "]))));
var templateObject_1$j, templateObject_2$f, templateObject_3$b, templateObject_4$8, templateObject_5$7, templateObject_6$6, templateObject_7$4, templateObject_8$4, templateObject_9$4, templateObject_10$2;

var Container$e = styled.div(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  display: flex;\n"], ["\n  display: flex;\n"])));
var RoundLoadingShimmer = styled(LoadingShimmer)(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  border-radius: 100%;\n  height: 36px;\n  width: 36px;\n  margin-right: -8px;\n"], ["\n  border-radius: 100%;\n  height: 36px;\n  width: 36px;\n  margin-right: -8px;\n"])));
var Fallback$2 = function () { return (React.createElement(Container$e, null,
...
var ProfileContainer = styled.div(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n"], ["\n  display: flex;\n  flex-direction: row;\n"])));
var PlusIcon = styled.div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  border: 2px solid #fff;\n  height: 36px;\n  width: 36px;\n  margin-right: -8px;\n  background-color: #f6f6f6;\n  ", ";\n  color: ", ";\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"], ["\n  border: 2px solid #fff;\n  height: 36px;\n  width: 36px;\n  margin-right: -8px;\n  background-color: #f6f6f6;\n  ", ";\n  color: ", ";\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])), Font("milli"), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.semiTitle;
});
var ProfileGroup = function (_a) {
    ...
    if (loading) {
        return React.createElement(Fallback$2, null);
    }
...
var Fallback$1 = function () { return (React.createElement(Container$f, null,
    React.createElement(ExploreImage, { imgSrc: "", loading: true }),
    React.createElement(SecondHalf, null,
        React.createElement(Title$2, null,
            React.createElement(LoadingShimmer, null, "loading")),
        React.createElement(SessionCountdown, { endTime: 0, loading: true }),
        React.createElement(Divider$3, null),
        React.createElement(ExploreInfoContainer, null,
            React.createElement(ExploreInfo, { title: "Participants", text: React.createElement(LoadingShimmer, null, "loading"), unit: "People" }),
            React.createElement(ExploreInfo, { title: "Pool Amount", text: React.createElement(LoadingShimmer, null, "loading"), unit: React.createElement(LoadingShimmer, null, "loading") })),
...
var Container$d = styled.div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  position: relative;\n  border-radius: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  display: flex;\n  flex-direction: column;\n  padding: 12px;\n  grid-gap: 20px;\n  align-items: center;\n  color: black;\n\n  ", "\n"], ["\n  position: relative;\n  border-radius: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  display: flex;\n  flex-direction: column;\n  padding: 12px;\n  grid-gap: 20px;\n  align-items: center;\n  color: black;\n\n  ",
    "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.section;
}, function (_a) {
...
var BadgeContainer = styled.div(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n  border: 2px solid ", ";\n  padding: 8px 18px;\n  border-radius: 70px;\n  width: fit-content;\n  height: fit-content;\n  grid-gap: 8px;\n  display: flex;\n  font-weight: 500;\n  ", ";\n  align-items: center;\n"], ["\n  border: 2px solid ", ";\n  padding: 8px 18px;\n  border-radius: 70px;\n  width: fit-content;\n  height: fit-content;\n  grid-gap: 8px;\n  display: flex;\n  font-weight: 500;\n  ", ";\n  align-items: center;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.border;
}, Font("nano"));
var BadgeIndicator = styled.div(templateObject_4$7 || (templateObject_4$7 = __makeTemplateObject(["\n  border-radius: 50%;\n  height: 8px;\n  width: 8px;\n  background-color: ", ";\n"], ["\n  border-radius: 50%;\n  height: 8px;\n  width: 8px;\n  background-color: ", ";\n"])), function (_a) {
    var color = _a.color;
    return color;
});
var NFTImage = styled.img(templateObject_5$6 || (templateObject_5$6 = __makeTemplateObject(["\n  border-radius: ", ";\n  width: 100%;\n  aspect-ratio: 1 / 1;\n  max-width: 200px;\n"], ["\n  border-radius: ", ";\n  width: 100%;\n  aspect-ratio: 1 / 1;\n  max-width: 200px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.section;
});
var Divider$2 = styled.hr(templateObject_6$5 || (templateObject_6$5 = __makeTemplateObject(["\n  width: 100%;\n  border-color: ", ";\n"], ["\n  width: 100%;\n  border-color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.border;
});
var Title$1 = styled.a(templateObject_7$3 || (templateObject_7$3 = __makeTemplateObject(["\n  ", "\n  text-align: center;\n  font-family: \"Bluu Next\";\n  overflow: \"hidden\";\n  text-decoration: none;\n  color: black;\n\n  &:focus,\n  &:hover,\n  &:visited {\n    color: black;\n  }\n\n  &::after {\n    transition: all ", ", opacity 0;\n    content: \"\";\n    position: absolute;\n    top: 0;\n    left: 0;\n    bottom: 0;\n    right: 0;\n  }\n\n  &:hover {\n    text-decoration: underline;\n    &::after {\n      opacity: 0.2;\n      background-color: white;\n    }\n  }\n"], ["\n  ", "\n  text-align: center;\n  font-family: \"Bluu Next\";\n  overflow: \"hidden\";\n  text-decoration: none;\n  color: black;\n\n  &:focus,\n  &:hover,\n  &:visited {\n    color: black;\n  }\n\n  &::after {\n    transition: all ", ", opacity 0;\n    content: \"\";\n    position: absolute;\n    top: 0;\n    left: 0;\n    bottom: 0;\n    right: 0;\n  }\n\n  &:hover {\n    text-decoration: underline;\n    &::after {\n      opacity: 0.2;\n      background-color: white;\n    }\n  }\n"])), Font("peta"), function (_a) {
    var theme = _a.theme;
    return theme.transitionTime.main;
});
var BottomContainer$1 = styled.div(templateObject_9$3 || (templateObject_9$3 = __makeTemplateObject(["\n  grid-gap: 30px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-bottom: 20px;\n\n  ", "\n"], ["\n  grid-gap: 30px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-bottom: 20px;\n\n  ",
    "\n"])), Media.lg(templateObject_8$3 || (templateObject_8$3 = __makeTemplateObject(["\n    margin-bottom: 28px;\n  "], ["\n    margin-bottom: 28px;\n  "]))));
var templateObject_1$g, templateObject_2$c, templateObject_3$a, templateObject_4$7, templateObject_5$6, templateObject_6$5, templateObject_7$3, templateObject_8$3, templateObject_9$3;

var ImageLoadingShimmer = styled(LoadingShimmer)(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  border-radius: ", ";\n  width: 100%;\n  aspect-ratio: 1 / 1;\n  max-width: 200px;\n"], ["\n  border-radius: ", ";\n  width: 100%;\n  aspect-ratio: 1 / 1;\n  max-width: 200px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.section;
});
    ...
    return (React.createElement(Container$d, null,
        React.createElement("div", { style: { width: "100%" } },
            React.createElement(BadgeContainer, null,
                React.createElement(BadgeIndicator, { color: theme.colors.utility.gray }),
                "Loading...")),
        React.createElement(ImageLoadingShimmer, null),
        React.createElement(Title$1, { href: "" },
            React.createElement(LoadingShimmer, null, "Loading")),
        React.createElement(ExploreInfoContainer, null,
            React.createElement(ExploreInfo, { title: "Participants", text: React.createElement(LoadingShimmer, null, "loading"), unit: "People" }),
            React.createElement(ExploreInfo, { title: "Pool Amount", text: React.createElement(LoadingShimmer, null, "loading"), unit: React.createElement(LoadingShimmer, null, "loading") })),
        React.createElement(Divider$2, null),
        React.createElement(BottomContainer$1, null,
            React.createElement(ProfileGroup, { imgs: [], numParticipants: 0, loading: true }),
            React.createElement(SessionCountdown, { endTime: 0, loading: true }))));
};
...
// You probably want to change this to something semantic or abandon it all together
var Container$c = styled.div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  justify-content: space-between;\n  align-items: center;\n\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  justify-content: space-between;\n  align-items: center;\n\n  ",
    "\n"])), Media.lg(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n    flex-direction: row;\n    justify-content: flex-start;\n  "], ["\n    flex-direction: row;\n    justify-content: flex-start;\n  "]))));
var InfoWrapper = styled.div(templateObject_5$5 || (templateObject_5$5 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: 50% 50%;\n  align-items: center;\n\n  ", "\n\n  ", "\n"], ["\n  display: grid;\n  grid-template-columns: 50% 50%;\n  align-items: center;\n\n  ",
    "\n\n  ",
    "\n"])), Media.sm(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n    grid-template-columns: repeat(3, calc(100%/3));\n  "], ["\n    grid-template-columns: repeat(3, calc(100%/3));\n  "]))), Media.lg(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n    width: 65%;\n    justfy-content: space-evenly;\n  "], ["\n    width: 65%;\n    justfy-content: space-evenly;\n  "]))));
var Title = styled(Container$z)(templateObject_7$2 || (templateObject_7$2 = __makeTemplateObject(["\n  display: flex;\n  font-family: \"Bluu Next\";\n  text-align: center;\n\n  ", "\n"], ["\n  display: flex;\n  font-family: \"Bluu Next\";\n  text-align: center;\n\n  ",
    "\n"])), Media.lg(templateObject_6$4 || (templateObject_6$4 = __makeTemplateObject(["\n    text-align: left;\n    flex: 1 0 auto;\n    padding: 0 36px;\n    width: 35%;\n  "], ["\n    text-align: left;\n    flex: 1 0 auto;\n    padding: 0 36px;\n    width: 35%;\n  "]))));
var StyledExploreInfo = styled(ExploreInfo)(templateObject_9$2 || (templateObject_9$2 = __makeTemplateObject(["\n  margin-top: 16px;\n\n  &:first-of-type {\n    margin-right: 16px;\n  }\n\n  ", "\n"], ["\n  margin-top: 16px;\n\n  &:first-of-type {\n    margin-right: 16px;\n  }\n\n  ",
...
var CardBar = function (_a) {
    ...
    return (React.createElement(Section, null,
        React.createElement(Container$c, null,
...
var templateObject_1$e, templateObject_2$b, templateObject_3$9, templateObject_4$6, templateObject_5$5, templateObject_6$4, templateObject_7$2, templateObject_8$2, templateObject_9$2;

var KiloStyled$2 = styled(StyledDiv)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  color: ", ";\n  font-weight: 600;\n"], ["\n  color: ", ";\n  font-weight: 600;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.semiTitle;
});
var Border = styled.div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  background-color: ", ";\n  height: 2px;\n  width: 100%;\n"], ["\n  background-color: ", ";\n  height: 2px;\n  width: 100%;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core.border;
});
var Container$b = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  grid-gap: 15px;\n  width: 100%;\n  height: 100%;\n"], ["\n  display: flex;\n  flex-direction: column;\n  grid-gap: 15px;\n  width: 100%;\n  height: 100%;\n"])));
var CardWithTitle = function (_a) {
    ...
    return (React.createElement(CardBackground, null,
        React.createElement(Container$b, { style: __assign({}, style) },
...
var Link = styled.a(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  padding: 8px 0px;\n  text-decoration: none;\n  transition: ", ";\n  &:hover {\n    opacity: 0.8;\n  }\n"], ["\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  padding: 8px 0px;\n  text-decoration: none;\n  transition: ", ";\n  &:hover {\n    opacity: 0.8;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.transitionTime.main;
});
var KiloStyled$1 = styled(StyledDiv)(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  color: ", ";\n  font-weight: 500;\n"], ["\n  color: ", ";\n  font-weight: 500;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core[900];
});
var Container$a = styled.div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  height: 100%;\n  grid-gap: 5px;\n"], ["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  height: 100%;\n  grid-gap: 5px;\n"])));
...
var AnimatedDropdown = styled(Dropdown)(templateObject_1$b || (templateObject_1$b = __makeTemplateObject([""], [""])));
var AccordionButton = styled(Button)(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  display: flex;\n  color: ", ";\n  padding: 16px 6px;\n  align-items: center;\n  width: 100%;\n\n  & ", " {\n    transform: ", ";\n  }\n"], ["\n  display: flex;\n  color: ", ";\n  padding: 16px 6px;\n  align-items: center;\n  width: 100%;\n\n  & ", " {\n    transform: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledKilo$2 = styled(StyledDiv)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  padding-left: 16px;\n  font-weight: bold;\n"], ["\n  padding-left: 16px;\n  font-weight: bold;\n"])));
var AccordionItems = styled.div(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  margin-top: 2px;\n  display: ", ";\n  flex-wrap: wrap;\n"], ["\n  margin-top: 2px;\n  display: ", ";\n  flex-wrap: wrap;\n"])), function (_a) {
    var isOpen = _a.isOpen;
    return (isOpen ? "flex" : "none");
});
// You probably want to change this to something semantic or abandon it all together
var Container$9 = styled.div(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n"], ["\n  display: flex;\n  flex-direction: column;\n"])));
...
var templateObject_1$b, templateObject_2$8, templateObject_3$6, templateObject_4$5, templateObject_5$4;
...
var Container$8 = styled.div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  display: grid;\n\n  ", "\n"], ["\n  display: grid;\n\n  ",
    "\n"])), Media.sm(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n    grid-template-columns: 45% 55%;\n  "], ["\n    grid-template-columns: 45% 55%;\n  "]))));
var LeftHalf = styled.div(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  grid-gap: 20px;\n\n  ", "\n"], ["\n  width: 100%;\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  grid-gap: 20px;\n\n  ",
    "\n"])), Media.lg(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n    padding: 28px 64px;\n  "], ["\n    padding: 28px 64px;\n  "]))));
var RightHalf = styled.div(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  width: 100%;\n  min-height: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  grid-gap: 20px;\n  padding: 20px 0;\n\n  ", "\n\n  ", "\n"], ["\n  width: 100%;\n  min-height: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  grid-gap: 20px;\n  padding: 20px 0;\n\n  ",
    "\n\n  ",
...
var Image = styled.img(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n  width: 100%;\n  aspect-ratio: 1 / 1;\n  border-radius: ", ";\n"], ["\n  width: 100%;\n  aspect-ratio: 1 / 1;\n  border-radius: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.main;
});
var CountdownContainer = styled.div(templateObject_9$1 || (templateObject_9$1 = __makeTemplateObject(["\n  display: flex;\n  width: 100%;\n  justify-content: center;\n"], ["\n  display: flex;\n  width: 100%;\n  justify-content: center;\n"])));
var TitleContainer = styled.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  grid-gap: 12px;\n  text-align: center;\n\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  grid-gap: 12px;\n  text-align: center;\n\n  ",
    "\n"])), Media.sm(templateObject_10$1 || (templateObject_10$1 = __makeTemplateObject(["\n    text-align: left;\n  "], ["\n    text-align: left;\n  "]))));
var Description = styled(StyledDiv)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core[800];
});
var BottomButtonContainer = styled.div(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  grid-gap: 20px;\n  display: flex;\n  width: 100%;\n  flex-direction: column;\n"], ["\n  grid-gap: 20px;\n  display: flex;\n  width: 100%;\n  flex-direction: column;\n"])));
var LockOuterContainer = styled.div(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  display: flex;\n  width: 100%;\n  flex-direction: row;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  width: 100%;\n  flex-direction: row;\n  justify-content: space-between;\n"])));
var LockContainer = styled.div(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n  display: flex;\n  grid-gap: 18px;\n  padding-left: 10px;\n  align-items: center;\n"], ["\n  display: flex;\n  grid-gap: 18px;\n  padding-left: 10px;\n  align-items: center;\n"])));
var FullWidthButton$1 = styled(Button)(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
var PricingSessionMainComponent = function (_a) {
    ...
    var _b = useState(0), pageState = _b[0], setPageState = _b[1];
    var _c = useState(""), appraisal = _c[0], setAppraisal = _c[1];
    var _d = useState(""), stake = _d[0], setStake = _d[1];
    return (React.createElement(Section, null,
        React.createElement(Container$8, null,
            React.createElement(LeftHalf, null,
                React.createElement(Image, { src: cardInfo.nftSrc }),
                React.createElement(CountdownContainer, null,
                    React.createElement(SessionCountdown, { endTime: cardInfo.endTime }))),
            React.createElement(RightHalf, null, currentState === SessionState.Vote ? (React.createElement(React.Fragment, null,
                React.createElement(TitleContainer, null,
                    React.createElement(Container$I, { style: { fontFamily: "Bluu Next" } }, pageState === 0
                        ? "What's your appraisal?"
                        : "Stake your bet"),
                    React.createElement(Description, null, pageState === 0
                        ? "How much do you think this NFT is worth?"
                        : "How much would you like to stake?")),
                participation === undefined ? (React.createElement(Input, { showEth: true, name: "Amount", type: "text", value: pageState === 0 ? appraisal : stake, onChange: function (value) {
                        return pageState === 0 ? setAppraisal(value) : setStake(value);
                    }, placeholder: pageState === 0 ? "Appraisal Amount" : "Stake Amount" })) : (React.createElement(React.Fragment, null,
                    React.createElement(MiniList, { info: {
                            Appraisal: participation.appraisal + " ETH",
                            Stake: participation.stake + " ETH",
                            "Seed Number": participation.seedNumber,
                        }, isDark: true }))),
                React.createElement(BottomButtonContainer, null, participation === undefined ? (React.createElement(React.Fragment, null,
                    React.createElement(LockOuterContainer, null,
                        React.createElement(LockContainer, null,
                            React.createElement("img", { style: { width: pageState === 0 ? 24 : 35 }, src: pageState === 0 ? Lock : EthLogo, alt: pageState === 0 ? "Lock" : "Ethereum Logo" }),
                            React.createElement(TitleContainer, { style: { gridGap: 1 } },
                                React.createElement(Description, { style: { fontWeight: 600 } }, pageState === 0
                                    ? "Private until you reveal"
                                    : "Abacus Balance"),
                                React.createElement(Description, null, pageState === 0
                                    ? "Appraisals are anonymous until all submissions are in."
                                    : currentEthBalance + " ETH"))),
                        pageState !== 0 ? (React.createElement(Button, { onClick: function () { return openDepositModal(); }, buttonType: ButtonType.White }, "Deposit Funds")) : null),
                    pageState === 0 ? (React.createElement(FullWidthButton$1, { onClick: function () {
                            return appraisal !== "" ? setPageState(1) : null;
                        } }, "Appraise")) : (React.createElement(TitleContainer, { style: { flexDirection: "row" } },
                        React.createElement(Button, { buttonType: ButtonType.Gray, onClick: function () { return setPageState(0); } }, "Back"),
                        React.createElement(FullWidthButton$1, { onClick: function () { return onMainClick(); } }, "Submit Stake"))))) : (React.createElement(React.Fragment, null,
                    React.createElement(TitleContainer, { style: { flexDirection: "row" } },
                        React.createElement(FullWidthButton$1, { buttonType: ButtonType.Gray }, "Add to Bounty"),
                        React.createElement(FullWidthButton$1, { onClick: function () { return onMainClick(); } }, "Edit Appraisal"))))))) : null))));
};
var templateObject_1$a, templateObject_2$7, templateObject_3$5, templateObject_4$4, templateObject_5$3, templateObject_6$3, templateObject_7$1, templateObject_8$1, templateObject_9$1, templateObject_10$1, templateObject_11, templateObject_12, templateObject_13, templateObject_14, templateObject_15, templateObject_16;

// You probably want to change this to something semantic or abandon it all together
var Container$7 = styled.a(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  text-decoration: none;\n  transition: ", ";\n  display: flex;\n  flex-direction: column;\n  width: 220px;\n  &:hover {\n    opacity: 0.8;\n  }\n"], ["\n  text-decoration: none;\n  transition: ", ";\n  display: flex;\n  flex-direction: column;\n  width: 220px;\n  &:hover {\n    opacity: 0.8;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.transitionTime.main;
});
var ImageContainer = styled.img(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  border-radius: ", ";\n"], ["\n  border-radius: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.borderRadius.main;
});
var BottomContainer = styled.div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  margin-top: 11px;\n  padding: 0px 3px;\n"], ["\n  display: flex;\n  justify-content: space-between;\n  margin-top: 11px;\n  padding: 0px 3px;\n"])));
var KiloStyled = styled(StyledDiv)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  color: ", ";\n  font-weight: 500;\n"], ["\n  color: ", ";\n  font-weight: 500;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core[900];
});
var OpenseaObject = function (_a) {
    var src = _a.src, link = _a.link;
    return (React.createElement(Container$7, { href: link },
...
var templateObject_1$9, templateObject_2$6, templateObject_3$4, templateObject_4$3;

var Container$6 = styled.div(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  width: 100%;\n  overflow-x: scroll;\n  overflow-y: hidden;\n  display: flex;\n  grid-gap: 20px;\n"], ["\n  width: 100%;\n  overflow-x: scroll;\n  overflow-y: hidden;\n  display: flex;\n  grid-gap: 20px;\n"])));
...
var ListContainer = styled.div(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  height: 100%;\n  overflow: scroll;\n  overflow-x: hidden;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  grid-gap: 15px;\n"], ["\n  height: 100%;\n  overflow: scroll;\n  overflow-x: hidden;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  grid-gap: 15px;\n"])));
var RowContainer = styled.div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  display: flex;\n  width: 100%;\n  grid-gap: 10px;\n"], ["\n  display: flex;\n  width: 100%;\n  grid-gap: 10px;\n"])));
var ProfileImage = styled.img(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  width: 48px;\n  height: 48px;\n  border-radius: 50%;\n"], ["\n  width: 48px;\n  height: 48px;\n  border-radius: 50%;\n"])));
var TextContainer = styled.div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  display: flex;\n  width: 100%;\n  flex-direction: column;\n  grid-gap: 3px;\n"], ["\n  display: flex;\n  width: 100%;\n  flex-direction: column;\n  grid-gap: 3px;\n"])));
var StyledKilo$1 = styled(StyledDiv)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.core[900];
});
var EmptyContainer = styled.div(templateObject_6$2 || (templateObject_6$2 = __makeTemplateObject(["\n  display: flex;\n  width: 100%;\n  height: 100%;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  grid-gap: 5px;\n"], ["\n  display: flex;\n  width: 100%;\n  height: 100%;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  grid-gap: 5px;\n"])));
    ...
    return (React.createElement(CardWithTitle, { title: "Activity" },
        React.createElement(ListContainer, null, activityList.length > 0 ? (_.map(activityList, function (activity) { return (React.createElement(RowContainer, { key: activity.id },
            ...
            React.createElement(TextContainer, null,
                ...
                React.createElement(StyledKilo$1, null,
            ...
            React.createElement(Container$B, { style: { fontWeight: 500, textAlign: "center" } }, "Nobody has appraised yet!"),
            React.createElement(StyledKilo$1, { style: { textAlign: "center" } }, "This will show all the people who submitted their appraisal."))))));
};
var templateObject_1$7, templateObject_2$5, templateObject_3$3, templateObject_4$2, templateObject_5$2, templateObject_6$2;

var FullWidthButton = styled(Button)(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
var FundCard = function (_a) {
    var title = _a.title, buttonTitle = _a.buttonTitle, onClick = _a.onClick;
    var _b = useState(""), value = _b[0], setValue = _b[1];
    return (React.createElement(CardWithTitle, { noBorder: true, style: { height: 250, justifyContent: "space-between" }, title: title },
        React.createElement(React.Fragment, null,
            React.createElement(Input, { showEth: true, placeholder: "0", type: "text", name: "Funds", value: value, onChange: function (amount) { return setValue(amount); } }),
            React.createElement(FullWidthButton, { disabled: value.length === 0, buttonType: ButtonType.Standard, onClick: onClick }, buttonTitle))));
};
var templateObject_1$6;

var Container$5 = styled.div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  display: ", ";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background: ", ";\n  background-repeat: no-repeat;\n  background-size: cover;\n  backdrop-filter: blur(40px);\n  z-index: ", ";\n  padding: 1rem;\n  transition: opacity 0.33s ease, z-index 0.33s ease;\n  opacity: ", ";\n  overflow-y: scroll;\n\n  ", "\n"], ["\n  display: ", ";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background: ", ";\n  background-repeat: no-repeat;\n  background-size: cover;\n  backdrop-filter: blur(40px);\n  z-index: ", ";\n  padding: 1rem;\n  transition: opacity 0.33s ease, z-index 0.33s ease;\n  opacity: ", ";\n  overflow-y: scroll;\n\n  ",
    "\n"])), function (_a) {
    var isOpen = _a.isOpen;
    ...
    var isOpen = _a.isOpen;
    return (isOpen ? 1 : 0);
}, Media.sm(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    overflow-y: hidden;\n  "], ["\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    overflow-y: hidden;\n  "]))));
...
var OpenAppModal = function (_a) {
    ...
    return (React.createElement(Container$5, { onClick: closeModal, isOpen: isOpen },
...
var Container$2 = styled.nav(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  display: flex;\n  padding: 16px;\n\n  ", "\n\n  ", "\n"], ["\n  display: flex;\n  padding: 16px;\n\n  ",
    "\n\n  ",
    "\n"])), function (_a) {
...
var StyledKilo = styled(StyledDiv)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  cursor: pointer;\n  transition: ", ";\n  &:hover {\n    opacity: 0.7;\n  }\n"], ["\n  cursor: pointer;\n  transition: ", ";\n  &:hover {\n    opacity: 0.7;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.transitionTime.main;
});
var PortalNavbar = function (_a) {
    ...
    return (React.createElement(Container$2, { menuOpen: menuOpen },
        React.createElement(SideContainer, { style: { gridGap: 8 }, menuOpen: menuOpen },
            React.createElement(Logo, { onClick: onClick }),
            React.createElement(Divider, null),
            React.createElement(Container$x, null, "Crowds"),
        ...
        React.createElement(SideContainer, { style: { gridGap: 32 }, isOptions: true, menuOpen: menuOpen },
            React.createElement(StyledKilo, { onClick: onBalanceClick },
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(Container, null,
            React.createElement(CarouselItem, null,
                React.createElement(ExploreImage, { loading: loading, onClick: function () {
                        if (currentMid === 0) {
                    ...
                    }, enableFullBorderRadius: true, imgSrc: (_c = (_b = cards[currentMid === 0 ? cards.length - 1 : currentMid - 1]) === null || _b === void 0 ? void 0 : _b.nftSrc) !== null && _c !== void 0 ? _c : "" })),
            React.createElement(CarouselItem, null,
                React.createElement(ExploreCard, __assign({}, cards[currentMid], { loading: loading }))),
            React.createElement(CarouselItem, null,
                React.createElement(ExploreImage, { loading: loading, onClick: function () {
                    ...
                    }, enableFullBorderRadius: true, imgSrc: (_e = (_d = cards[currentMid === cards.length - 1 ? 0 : currentMid + 1]) === null || _d === void 0 ? void 0 : _d.nftSrc) !== null && _e !== void 0 ? _e : "" })))));
};
var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6;

export { AbacusBalance, AbacusBar, AbacusCrowds as AbacusCrowdsIcon, Abacus as AbacusIcon, AbacusSpot as AbacusSpotIcon, Accordion, ActivitySection, Button, ButtonType, CardBackground, CardBar, CardWithTitle, Checkbox, Close, Divider$3 as Divider, Dropdown, Eth as ETH, Container$I as Exa, ExploreCard, ExploreCarousel, ExploreImage, ExploreInfo, ExploreInfoContainer, ExploreScrollableCard, Extras, Flex, Font, FontImport, FundCard, Container$H as Giga, Container$G as H1, Container$F as H2, Container$E as H3, Container$D as H4, Container$C as H5, StyledH6 as H6, Infographic, Input, StyledDiv as Kilo, LinkImage, LoadingShimmer, Lock$1 as Lock, Logo, Media, Container$B as Mega, Container$A as Milli, MiniList, OpenAppModal as Modal, Navbar, StyledP as P, PartOfCollection, PersistentBanner, Container$z as Peta, PortalNavbar, PreviousSessionsAutoScroll, PriceHistory, PricingSessionMainComponent, ProfileGroup, ProfileIcon, ProfileInfo, Section, SessionCard, SessionCountdown, Container$y as Small, SocialLinks, SplitSection, StatInfo, Container$x as Tera, VisuallyHidden, Container$w as Yotta, Container$v as Zetta, breakpoints, defaultTheme };
